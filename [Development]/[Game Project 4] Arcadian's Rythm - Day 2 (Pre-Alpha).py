...
Sprite_Direwolf = pygame.image.load("Sprite_Direwolf.png")

# Icon
Icon_Arrow_A = pygame.image.load("Icon_Arrow_A.png")
Icon_Arrow_B = pygame.image.load("Icon_Arrow_B.png")
...
def Main():
    ...
    # Loading List_Enemies
        ...
        List_Enemies = [List_Enemies[x:x+4] for x in range(0, len(List_Enemies),4)]     # List every 4 parameters for 1 Enemy
        
        Enemy_Count = len(List_Enemies)         # Total Enemy Count

    # Debug - Checking List_Enemies
##        for Enemy in List_Enemies:
##            print(Enemy)
##            for Parameters in Enemy:
##                print(Parameters)
    ...
    # Starting Parameters
        ...
        Enemy_X         = [0] * Enemy_Count     # List X
        Enemy_Y         = [0] * Enemy_Count     # List Y
        Enemy_Speed     = [0] * Enemy_Count     # List Speed

        n = 0
        for Enemy in List_Enemies:
            Enemy_X[n]      = int(Enemy[1])         # Position X
            Enemy_Y[n]      = int(Enemy[2])         # Position Y
            Enemy_Speed[n]  = int(Enemy[3])         # Enemy Speed
            n = n + 1
        ...
        # Buttons
            ...
            # Arrow - Position
                Arrow_A_Rect.center = (Enemy_X[n], Enemy_Y[n]+90)
                gameDisplay.blit(Icon_Arrow_A, Arrow_A_Rect)
            
            # Enemy - Position
                Enemy_Sprite = globals()[List_Enemies[n][0]]                # Variable (Sprite Name)
                Enemy_Sprite_Rect = Enemy_Sprite.get_rect()                 # Getting Rectangle
                Enemy_Sprite_Rect.center = (Enemy_X[n],Enemy_Y[n])          # Centering Sprite
                gameDisplay.blit(Enemy_Sprite, Enemy_Sprite_Rect)           # Displaying Sprite
